...
const QSlipModal = ({ open, handleClose, bookingData }) => {
  console.log("Modal open?", open, "Data:", bookingData);
  ...
  <html>
    ...
    <body>
      <div class="print-container">
        ...
        ['Date', formatDate(bookingData?.quotationDate)],
        ...
        ['Receiver', bookingData?.fromCustomerName || 'N/A'],
